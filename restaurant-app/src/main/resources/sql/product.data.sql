INSERT INTO `VolumeEntity`(`id`, `capacity`, `unitEnum`)
...
INSERT INTO `IngredientEntity`(`id`, `name`, `volume_id`)
...
# Category
INSERT INTO `CategoryEntity`(`id`, `name`, `orderOnList`, `restaurantReference`) VALUES
...
# PRODUCTS
INSERT INTO `ProductEntity`(`id`, `available`, `description`, `name`, `photoUrl`, `price`, `restaurantReference`, `category_id`, `createdAt`, `updatedAt`) VALUES
